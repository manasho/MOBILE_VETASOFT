...
class ApiServiceHistorial {
  ...
  static Future<List<HistorialMedico>> obtenerHistorialPorAnimal(int animalId) async {
    try {
      ...
      print('❌ Error en ApiServiceHistorial.obtenerHistorialPorAnimal: $e');
      return [];
    }
  }
  ...
  static Future<List<Map<String, dynamic>>> obtenerTiposConsulta() async {
    try {
      ...
      print('❌ Error en ApiServiceHistorial.obtenerTiposConsulta: $e');
      return [];
    }
  }
  ...
  static Future<bool> guardarRegistro(Map<String, dynamic> data) async {
    try {
      ...
      print('❌ Error en ApiServiceHistorial.guardarRegistro: $e');
      return false;
    }
  }
}
